...
#                                     descriptions at ~250 chars (this plugin's
#                                     conventions cap them at 250, so the tier
#                                     is exact).
#   skills/**/SKILL.md      → 600  — skill descriptions are deliberately
#                                     trigger-engineered (they must fire the
#                                     right skill), so 600 matches the plugin's
#                                     skill-description conventions cap, NOT a
#                                     target. Do not tighten without eval
#                                     evidence that a shorter description
