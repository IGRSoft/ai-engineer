...
1. **Classify the asset** — product prompt vs Claude Code meta-prompt; meta-prompts route to the orchestrator's meta-prompt engineer immediately (routing rule above).
