...
description: >-
  ...
  meta-prompts → corpflow:prompt-engineer.
---
...
Owning agent: `ai-engineer:ai-prompt-engineer` (product/application prompts). Claude Code meta-prompts — agents, commands, skills — belong to `corpflow:prompt-engineer`, not here.
...
- Claude Code agent/command/skill prompts → `corpflow:prompt-engineer`
