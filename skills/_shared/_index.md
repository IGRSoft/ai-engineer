...
| File | Description |
|------|-------------|
| `workflow-integration/SKILL.md` | Guide for integrating with the igrsoft 11-stage workflow system (v3.36.0) — pipeline, invocation, gates, artifact filename contract, qualified agent names |
...
- **Integrate with an igrsoft worktask** → `workflow-integration/SKILL.md`
