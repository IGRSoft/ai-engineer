...
Scenario: worktask `wt-118` adds a reranking step to an existing RAG retriever. `corpflow:developer` detects the `ai` platform key and delegates DV to `ai-engineer:llm-engineer`.
