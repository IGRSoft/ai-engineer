...
Primary artifact `.context/developer-review-N.md` is owned by igrsoft's technical-lead; use this when an ai-engineer agent takes over DR or contributes the review body. ai-code-fixer appends retry narratives to `.context/errors/ai-code-fixer.md` instead.
